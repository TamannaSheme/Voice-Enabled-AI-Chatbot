...
var JestReporter = (function () {
    function JestReporter(globalConfig, options) {
        ...
        var hooksPath = ($c.get(this, 'testResults.options.hooks') || "").replace("<rootDir>", globalConfig.rootDir);
        options.hooks = hooksPath ? $c.include(hooksPath) : {};
    }
    JestReporter.prototype.onTestResult = function (jtest, testResult, aggregatedResult) {
        var suiteGroups = {};
